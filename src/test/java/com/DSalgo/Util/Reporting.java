...
public class Reporting extends TestListenerAdapter{
   ...
   static	public ExtentReports extent;
	...
	public void onStart(ITestContext testcontext) {
		...
		File file = new File("C:\\Users\\HP\\eclipse-workspace\\DSalgoProject\\test-output\\"+repName);
		//htmlReporter =new ExtentSparkReporter("Spark.html");
		htmlReporter =new ExtentSparkReporter("C:\\Users\\HP\\eclipse-workspace\\DSalgoProject\\test-output\\"+repName);
		
		try {
			htmlReporter.loadXMLConfig("C:\\Users\\HP\\eclipse-workspace\\DSalgoProject\\extent-config.xml");
		} catch (IOException e) {
